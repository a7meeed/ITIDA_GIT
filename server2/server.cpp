...
/********************************************************************************************/
        case 5:
           ...
           //  quint16 count;
           // inStream>>account;
           //  QString m_accountnumber=Cjison::printObjectFields(file_json,account,accountNumber);
           //  inStream>>count;
           //  QString data3=ViewTransactionHistory(m_accountnumber,count);
           //  outStream<<data3;
            break;
        default:
            break;
...
//***********************view bank data base**********
    ...
    case 9:
        ...
        if(admin_name == data2){
            inStream>>account;
            Cjison::deleteObject(file_json, account);
            data="delet succsses !";
            outStream<<data;
        }
        break;
